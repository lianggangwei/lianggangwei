...
print("=" * 60)
print("Qwen 千问模型本地演示 (7B 4-bit 量化版 - ModelScope)")
print("=" * 60)
...
try:
    ...
    print(f"\n❌ 缺少依赖库: {e}")
    print("请先运行: python install_modelscope.py")
    sys.exit(1)
...
def setup_model():
    ...
    try:
        ...
        print("   💡 使用 ModelScope 国内镜像，下载速度快！")
        ...
        print(f"\n❌ 模型加载失败: {e}")
        print("\n💡 提示:")
        print("   1. 如果显存不足，试试运行: python qwen_modelscope.py (1.8B版本)")
        print("   2. 确保网络连接正常")
        return None, None
