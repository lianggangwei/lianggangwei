...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .section { background: #f8f9fa; border-radius: 8px; padding: 20px; }
        .section h2 { color: #1a1a2e; margin-bottom: 15px; font-size: 18px; }
        .editor-container { display: flex; flex-direction: column; height: 400px; }
        textarea { flex: 1; width: 100%; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; font-family: 'Consolas', monospace; font-size: 14px; resize: none; background: #1e1e1e; color: #d4d4d4; }
        ...
        .btn-info { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; }
        .btn-info:hover { transform: translateY(-2px); box-shadow: 0 5px 15px rgba(245, 87, 108, 0.4); }
        .output { background: white; border: 2px solid #e0e0e0; border-radius: 8px; padding: 15px; min-height: 200px; max-height: 400px; overflow-y: auto; font-family: 'Consolas', monospace; font-size: 13px; white-space: pre-wrap; }
        .error { color: #e74c3c; background: #fee; padding: 8px 12px; border-radius: 4px; margin: 5px 0; border-left: 4px solid #e74c3c; }
        .warning { color: #f39c12; background: #fff3cd; padding: 8px 12px; border-radius: 4px; margin: 5px 0; border-left: 4px solid #f39c12; }
        .success { color: #27ae60; background: #d4edda; padding: 8px 12px; border-radius: 4px; margin: 5px 0; border-left: 4px solid #27ae60; }
        .info { color: #3498db; background: #d1ecf1; padding: 8px 12px; border-radius: 4px; margin: 5px 0; border-left: 4px solid #3498db; }
